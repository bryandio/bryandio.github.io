...
var question1 = function(){
    ...
    $(".buttons").append("<btton class='btn btn-warning q1-no'> NO</button>");
    ...
    //Run Question 2
    $(".narrative").html("This app is not for you!!");
...
var question2 = function(){
    ...
    $(".q2").show();
    $(".buttons").html("<button class='btn btn-danger q2-rpg'>RPG</button>");
    $(".buttons").append("<button class='btn btn-danger q2-fps'>FPS</button>");
    $(".buttons").append("<button class='btn btn-danger q2-sports'>SPORTS</button>");
    $(".buttons").append("<button class='btn btn-danger q2-adventure'>ADVENTURE</button>");
    $(".buttons").append("<button class='btn btn-danger q2-mmo'>MMO</button>");
...
var q3_buttons = function(b1Text, b2Text){
    ...
    $(".buttons").html("<button class='btn btn-success q3-button1'>" + b1text + "</button>");
    $(".buttons").append("<button class='btn btn-success q3-button2'>" + b2text + "</button>");
